export default {
  ...
  app: {
    ...
    'createTime': '作成時間',
    'id': 'ID',
    'doubleClickEdit': 'ダブルクリックして編集します',
    'uploadRunConfig': '実行構成ファイルをアップロードする',
    'true': 'はい',
    'false': 'いいえ',
    'planStartTime': '計画実行時間',
    'startTime': '走行開始時間',
    'endTime': '終了実行時間',
    'abortTime': '終了実行時間',
    'runTimeError': '実行时エラー',
    'actions': '操作する',
    'planToStart': '実行する計画を立てる',
    'start': '操作を開始する',
    'abort': '操作を終了する',
    'downloadResult': '実行結果をダウンロードする',
    'dragFileHereOrClickUpload': 'ここにファイルをドラッグ アンド ドロップするか、ここをクリックしてアップロードします',
    'cancel': 'キャンセル',
    'confirm': '確認する',
    'success': '成功',
    'fail': '失敗',
    ...
    'edit': '編集',
    'create': '新築',
    'runRealTimeMonitor':'リアルタイムモニタです',
  },
  example: {
